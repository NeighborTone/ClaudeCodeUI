...
class ThinkingSelectorWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.thinking_levels = [
            ("think", "think - 通常の思考"),
            ("think more", "think more - もう少し考える"),
            ("think harder", "think harder - より深く考える"),
            ("think hard", "think hard - しっかり考える"),
            ("think deeply", "think deeply - 深く考える"),
            ("think intensely", "think intensely - 集中的に考える"),
            ("think longer", "think longer - 長時間考える"),
            ("think a lot", "think a lot - たくさん考える"),
            ("think about it", "think about it - じっくり考え込む"),
            ("think very hard", "think very hard - とても深く考える"),
            ("think really hard", "think really hard - 非常に深く考える"),
            ("think super hard", "think super hard - 超深く考える"),
            ("megathink", "megathink - メガ思考"),
            ("ultrathink", "ultrathink - 極限思考")
        ]
